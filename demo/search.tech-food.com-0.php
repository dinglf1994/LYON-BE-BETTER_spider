...
define('DATA_PATH', APP_PATH. '/../../search.tech-food.com/meat/');
...
$configs = array(
    ...
    'list_url_regexes' => array(
        "http://search.tech-food.com/ns.aspx\?q=%E8%82%89%E5%88%B6%E5%93%81&t=a&l=c&start=\d+",
    ),
...
$spider->on_scan_page = function($page, $content, $phpspider)
{
    ...
    while ($i < 1001) {
        $j = $i * 10;
        $url = "http://search.tech-food.com/ns.aspx?q=%E8%82%89%E5%88%B6%E5%93%81&t=a&l=c&start={$j}";
...
$spider->on_download_page = function ($page, $phpspider)
{
    ...
    if (!preg_match("#http://search.tech-food.com/ns.aspx\?q=%E8%82%89%E5%88%B6%E5%93%81&t=a&l=c&start=\d+#i", $page['request']['url'])) {

...
// +----------------------------------------------------------------------
// | Author: Seatle Yang <https://github.com/dinglf1994>
// +----------------------------------------------------------------------
...
class phpspider
{
    ...
    public function start()
    {
        ...
        if (log::$log_show)
        {
            ...
            $header .= "\n[ ".self::$configs['name']." Spider ] Working.. \n\n";
            $header .= "  * PHPSpider Version: ".self::VERSION."\n";
//            $header .= "  * Documentation: https://github.com/dinglf1994\n";
...
//                log::info("Result[{$fields_num}]: ".$fields_str);
                ...
                if (!empty(self::$configs['export'])) 
                {
                    ...
                    {
                        util::put_file_article(self::$export_file, md5($url), util::format_csv($fields)."\n", FILE_APPEND);
                    }
